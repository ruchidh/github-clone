...
export default function Example() {
  return (
    ...
    <section className="flex flex-col w-2/12 bg-white rounded-l-3xl">  <Sidebar /> </section>
    
     <section className="w-10/12 flex flex-col bg-white rounded-r-3xl"> 
      <header className="bg-white shadow">
        <div className="flex max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900">Repositories</h1>
          <input type="text" className=" text-pink-500" />
        </div>
      </header>
      <main>
      <div class="overflow-x-auto">
        <div class="min-w-screen min-h-screen bg-gray-100 flex justify-center bg-gray-100 font-sans overflow-hidden px-2">
            <div class="w-full">
